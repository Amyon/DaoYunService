...
### JVM
JVM_MEMORY="-Xmx256m -Xms256m -Xss1m -XX:MetaspaceSize=256m -XX:MaxMetaspaceSize=256m"
...
JVM_DEBUG="-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=16066"
